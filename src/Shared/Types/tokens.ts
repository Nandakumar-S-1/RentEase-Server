...
export const TokenTypes = {
    ...
    IGetTenantKycDocumentUseCase: 'IGetTenantKycDocumentUseCase',
    IChatRepository: 'IChatRepository',
    IPdfService: 'IPdfService',
    IMaintenanceRequestRepository: 'IMaintenanceRequestRepository',
    ICreateMaintenanceRequestUseCase: 'ICreateMaintenanceRequestUseCase',
    IGetMaintenanceRequestsUseCase: 'IGetMaintenanceRequestsUseCase',
    IUpdateMaintenanceStatusUseCase: 'IUpdateMaintenanceStatusUseCase',
    IAssignServiceProviderUseCase: 'IAssignServiceProviderUseCase',

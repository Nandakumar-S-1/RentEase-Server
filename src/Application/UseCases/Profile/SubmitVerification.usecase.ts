import { SubmitVerificationDTO } from "@application/Data-Transfer-Object/Profile/OwnerVerificationDTO";
...
import { DocumentAlreadySubmittedError, OwnerProfileNotFoundError } from "@shared/Errors/Owner_Errors";
...
export class SubmitVerificationUseCase implements ISubmitVerificationUseCase{
    ...
    async execute(dto:SubmitVerificationDTO){
        ...
        if(ownerProfile.verificationStatus===Owner_Verification_Staus.SUBMITTED){

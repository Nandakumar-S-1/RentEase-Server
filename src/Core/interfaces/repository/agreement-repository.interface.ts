...
export interface IAgreementRepository extends IBaseRepository<AgreementEntity, AgreementEntity, (entity: AgreementEntity) => Promise<AgreementEntity>> {
    ...
    updateKyc(id: string, kycUrl: string): Promise<AgreementEntity>;
}
